...
const styles = StyleSheet.create({
  ...
  logoRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 5 },
  crownImage: { width: 28, height: 42 },
  logoTextBlock: { flexDirection: 'column' },
  logoNameRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 3 },
  logoAU: { fontFamily: 'Times-Bold', fontSize: 20, lineHeight: 1 },
  logoElectronicBlock: { flexDirection: 'column', paddingBottom: 1 },
  logoElectronic: { fontFamily: 'Helvetica-Bold', fontSize: 9, lineHeight: 1 },
  logoSpareParts: { fontFamily: 'Helvetica', fontSize: 7, color: '#444', lineHeight: 1 },
  logoAddress: { fontFamily: 'Helvetica', fontSize: 6.5, color: '#555', marginTop: 2 },
  metaRight: { alignItems: 'flex-end', maxWidth: 150 },
  metaDate: { marginBottom: 5, fontSize: 8 },
  kepadaLabel: { color: '#6b7280', marginBottom: 1, fontSize: 7 },
  kepadaName: { fontFamily: 'Helvetica-Bold', fontSize: 9 },
  kepadaAlamat: { fontSize: 7, color: '#444' },
  divider: { borderBottom: '1px solid #1a1a1a', marginTop: 5, marginBottom: 0 },
  tableHeader: {
    flexDirection: 'row',
    paddingVertical: 2,
    paddingHorizontal: 3,
  ...
  colHarga: { width: 80, textAlign: 'right', paddingRight: 6 },
  ...
  pageSubtotalLabel: { fontFamily: 'Helvetica-Bold', fontSize: 8, color: '#374151' },
  pageSubtotalValue: { fontFamily: 'Helvetica-Bold', fontSize: 8, color: '#374151', width: 80, textAlign: 'right' },
  ...
  perhatianTitle: { fontFamily: 'Helvetica-Bold', fontSize: 7, marginBottom: 2 },
  perhatianText: { fontSize: 6.5, color: '#374151', lineHeight: 1.4 },
  signatureBlock: { flex: 1, alignItems: 'center' },
  signatureLine: { borderBottom: '1px solid #1a1a1a', marginTop: 16, marginBottom: 3, width: '80%' },
  totalArea: { alignItems: 'flex-end', minWidth: 95 },
  totalLabel: { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#111' },
  totalValue: { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#111', marginTop: 2 },
})
